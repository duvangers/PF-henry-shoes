...
import { addToLocalStorage, changeAmountFromLocalStorage, deleteFromLocalStorage, getCarritoFromStorage } from './getLocalstorage'
...
const rootReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.GET_ALL_USER_REVIEWS:
      ...
      case actionTypes.GET_ALL_PRODUCT_REVIEWS:
        return {
          ...state,
