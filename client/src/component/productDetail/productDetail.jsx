          ...
          <div className="col-xxl-10 col-xl-6 col-md-9 col-sm-9 mx-auto p-4">
            <div className="card shadow p-2 p-md-4">
                ...
                <div className="post-meta">
                  <div className="media d-flex align-items-center justify-content-between">
                    <div className="post-group">
                      <div className="label-top shadow-sm text-white">{details.brand.name}</div>
              ...
              <div className="card-body py-4 px-0">
                <div className="dropdown">
                  <div className="btn btn-secondary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    TALLES
                  </div>
                  <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                    {details.size_range.length ? (
                      details.size_range.map((e, i) => {
                        return (
                          <div key={i}>
                            <button className="dropdown-item" id={i} key={i} value={e} onClick={e => onChane(e)}>
                              {e.size}
                            </button>
                          </div>
                        )
            ...
            <li><a className="dropdown-item" href="#">algo mas</a></li> */}
                ...
                <ul className="list-group list-group-light list-group-small">
                  ...
                  <li className="list-group border-0 text-start">
                    <strong>
                      COLOR: <small className="fst-normal">{details.color.name}</small>
                    </strong>
                  </li>
                  <li className="list-group border-0 text-start">
                    <strong>
                  ...
                  <li className="list-group border-0 text-start">
                    <strong>
                      CATEGORIE: <small className="fst-normal">{details.categories.map(value => value.name).join('')}</small>
                    </strong>
                  </li>
                  <li className="list-group border-0 text-start">
                    <strong>
                      GENDER: <small className="fst-normal">{details.gender.name}</small>
                    </strong>
                  </li>
                </ul>
              </div>
